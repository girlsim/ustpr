...
class Main:
	...
	while indexNum <= indexMax:
	    ...
	    y += 32
	text = "Back"
	list = [text,(95,140,225),(x,y),self.goBack,None]
	self.characterMenu.append(list)
	...
	self.difficultyMenu = [
	    ...
	    ["Back",(95,140,225),(100,302),self.goBack,None]]
	self.startMenu = [
	    ["",(0,0,0)],
	...
	self.respawn_now = 500
	self.ms_per_round = 20
	...
	self.lerea = [(250,450),"lerea.png",6,4,6,1,2,3,["lereabullet.png",True,(65,115),15,6,(0,0),.2,False,False,20],2,["lereachargebullet.png",15,60,[-120,-180],30,2,[0,0],.2,0,0],50,.2,["shield.png",120,100],1]
	...
	self.dragonfly = [(250,450),"dragonfly.png",7,2,4,1,3,4,["dragonflybullet.png",True,(55,125),15,11,(-5,5),.2,False,0,0],1,["dragonflybullet.png",10,2160,[-1,-1],1.5,5,[-10,10],1,0,0],60,.2,["shield.png",25,80],1]

	self.ormrinn = [(250,450),"ormrinn.png",6,4,6,1,2,3,["ormrinnbullet.png",False,(0,0),35,10,(0,0),.5,False,0,0],2,["ormrinnbullet.png",10,2160,[-1,-1],2,5,[10,10],1,0,0],40,.1,["shield.png",100,50],2]
	...
	if self.ending_level == True:
		...
		self.level += 1
		self.moveable = False
		self.lastMenu = self.endLevelMenu
	...
	for b in pygame.sprite.spritecollide(self.playerImg,self.monster_bullet_group,False):
	    if b.grazed == False:
		self.score += 1
		b.grazed = True
	...
	while 1:
		...
		if event.type == pygame.QUIT:
			...
			if event.key == K_UP:
				...
				self.lastMenu = self.current_menu
				sel = self.current_selection
				self.current_selection = 1
		                self.current_menu[sel][3](self.current_menu[sel][4])
			    else:
				if self.current_menu[self.current_selection][0] != "Back":
				    self.lastMenu = self.current_menu
				sel = self.current_selection
				self.current_selection = 1
				self.current_menu[sel][3]()
			elif event.key == K_z:
			    self.goBack()
