...
class StageTwo(Level):
	...
	self.monsterKinds = [
	    ...
	    ["kappa.png",[6,100,.01,180,0,12,25],[False,5,[[5,1,20,"kappabullet.png",2,[0,0],1.02,0,90,40,6,60,0],[20,5,25,"kappabullet.png",4,[0,0],1.006,30,30,-1,0,0,0],[5,1,20,"kappabullet.png",2,[0,0],1.02,0,90,40,-6,60,0]],0,[0,"hitbox.png",0,[0,0],0,0,0]],2250,True]] 
